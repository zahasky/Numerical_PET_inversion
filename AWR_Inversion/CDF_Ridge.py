...
# axs.set_ylabel('CDF')
# axs.set_xlabel('log$_{10}$ Permeability Perturbation [mD] (EnKF-CNN)')
# axs.set_title('Berea')
...
#     tick.label.set_fontsize(fs-2)
#
# fig.suptitle('log$_{10}$ Permeability Perturbation [m$^{2}$] (EnKF-CNN)')
# # plt.xlabel('Permeability Perturbation')
...
axs2[0].set_title('Berea',fontsize = fs+8)
axs2[0].legend()
axs2[0].set_xlim(0,0.025)
...
axs2[1].set_title('Ketton',fontsize = fs+8)
axs2[1].legend()
axs2[1].set_xlim(0,0.025)
...
axs2[2].set_title('Edwards Brown',fontsize = fs+8)
axs2[2].legend()
axs2[2].set_xlim(0,0.025)
...
axs2[3].set_title('Navajo',fontsize = fs+8)
axs2[3].legend()
axs2[3].set_xlim(0,0.025)
