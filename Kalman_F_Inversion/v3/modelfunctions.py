...
def mt3d_conservative(dirname, raw_hk, prsity, grid_size, al, v,
                             ndummy_in, perlen_mt, timprs, mixelm, exe_name_mf, exe_name_mt, model_ws,):
# =============================================================================
#     UNIT INFORMATION
# =============================================================================
    ...
    for layer in range(0, nlay):
        for row in range(0, nrow):
            ...
            if core_mask[layer, row] > 0:
                q_dummy = q * dummy_slice_in[layer, row]
...
# =============================================================================
    ...
    return mf, mt, conc, timearray, hk_mean
