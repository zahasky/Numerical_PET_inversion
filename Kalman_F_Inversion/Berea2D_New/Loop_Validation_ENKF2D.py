...
nrow = 1 # number of rows / grid cells
...
mf, mt, conc, timearray, km2_mean = mt3d_pulse_injection_sim(enc_prsity, model_dirname, model_ws, inv_hk_chosen, grid_size, perlen_mf, nprs, mixelm, exe_name_mf, exe_name_mt)
...
Ly = nlay * grid_size[1]   # length of model in selected units
...
# imp = plt.pcolor(x, y, enc_time[:,0,:], cmap='PiYG', edgecolors='k', linewidths=0.2)
# cbar = plt.colorbar()
# cbar.set_label('Pore Volumes', fontsize=fs, **hfont)
# cbar.ax.tick_params(labelsize= (fs))
# ax2.set_xlabel('Distance from inlet [cm]', fontsize=fs-3, **hfont)
# ax2.tick_params(axis='both', which='major', labelsize=fs)
# plt.ylabel('Distance [cm]', fontsize=fs-3, **hfont)
# plt.title('Real Arrival Time Row 9', fontsize=fs, **hfont)
# plt.clim(min, max)
#
# ax2 = fig1.add_subplot(3, 2, 6, aspect='equal')
# imp = plt.pcolor(x, y, at_diff_norm[:,0,:], cmap='PiYG', edgecolors='k', linewidths=0.2)
# cbar = plt.colorbar()
# cbar.set_label('Pore Volumes', fontsize=fs, **hfont)
# cbar.ax.tick_params(labelsize= (fs))
# ax2.set_xlabel('Distance from inlet [cm]', fontsize=fs-3, **hfont)
# ax2.tick_params(axis='both', which='major', labelsize=fs)
# plt.ylabel('Distance [cm]', fontsize=fs-3, **hfont)
# plt.title('Validation Arrival Time Row 9', fontsize=fs, **hfont)
# plt.clim(min, max)
...
ax2 = fig1.add_subplot(1, 2, 1, aspect='equal')
imp = plt.pcolor(x, y, enc_time[:,0,:], cmap='PiYG', edgecolors='k', linewidths=0.2)
...
ax2.tick_params(axis='both', which='major', labelsize=fs)
plt.ylabel('Distance [cm]', fontsize=fs-3, **hfont)
plt.title('Real Arrival Time Row 9', fontsize=fs+5, **hfont)
plt.clim(min, max)
...
ax2.tick_params(axis='both', which='major', labelsize=fs)
plt.ylabel('Distance [cm]', fontsize=fs-3, **hfont)
plt.title('Validation Arrival Time Row 9', fontsize=fs+5, **hfont)
plt.clim(min, max)

plt.subplots_adjust(left=0.05,right=0.9, bottom=0.15, top=0.96, wspace=0.25, hspace=0.1)
