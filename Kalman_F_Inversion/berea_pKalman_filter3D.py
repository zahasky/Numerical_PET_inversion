...
ncol = 40
# Import data
arrival_data = np.loadtxt('D:\\Dropbox\\Codes\\Inversion\\Kalman_F_Inversion\\exp_data\\' + 'Berea_C1_2ml_2_3mm_at_norm.csv', delimiter=',')
...
np.savetxt('Berea_ensemble_parameter_space', Ps , delimiter=',', fmt='%.3e')
