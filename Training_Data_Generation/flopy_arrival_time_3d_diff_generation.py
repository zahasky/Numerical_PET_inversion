...
workdir = os.path.join('D:\\Training_data_generation_3D\\tdata_python26k\\\June_21_new_mask', directory_name)
# directory for homogeneous models
homogeneous_arrival_dir = os.path.join('D:\\Training_data_generation_3D\\tdata_python26k\\June_21_new_mask\\homogeneous_porosity_new_mask')
...
new_perm_field_dir = os.path.join('D:\\Training_data_generation_3D\\tdata_python26k\\June_21_new_mask\\syn_core_perm_maps_new_mask')
...
parameter_space_csv_name = 'parameter_space_26k_6_21.csv'

# number of training datasets desired
ntraining_data = 26001
